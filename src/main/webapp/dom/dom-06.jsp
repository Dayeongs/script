...
<script type="text/javascript">
	...
	function deleteAll() {
		...
		// let tbody = document.querySelector("#table-1 tbody")
		let tbody = document.querySelector("#tbody-users")
		
		// 2. 선택한 tbody엘리먼트의 html 컨텐츠를 전부 삭제하기
		tbody.innerHTML = "";	
	}
	...
	function deleteSelectedTr() {
		...
		// 2. 체크상태인 체크박스의 갯수를 조회해서 갯수가 0개면 경고창을 표시하고, 종료한다.
	...
	function toggleCheckbox() {
		...
		// 3. 전체선택/전체해제 체크박스의 체크상태를 조회한다.
		let currentChecked = toggleCheckbox.checked;
		
		// 4. 데이터행의 체크박스를 전체선택/전체해제 체크박스의 현재 체크상태와 같은 상태로 변환한다.
