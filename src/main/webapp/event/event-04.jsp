...
<div class="container">
	<div class="row">
		<div class="col-12">
			...
			<form class="border bg-light p-3" method="post" action="" onsubmit="handler3()">
				...
				<div class="form-group mb-3">
					<label class="form-lable">상태</label>
					<div class="form-check">
						<input type="radio" class="form-check-input"
						       name="status" value="1000" onchange="handler2()">
						 <label class="form-check-lavel">입고예정</label>
					</div>
					<div class="form-check">
						<input type="radio" class="form-check-input"
						       name="status" value="1001" onchange="handler2()">
						 <label class="form-check-lavel">판매중</label>
					</div>
					<div class="form-check">
						<input type="radio" class="form-check-input"
						       name="status" value="1002" onchange="handler2()">
						 <label class="form-check-lavel">재고없음</label>
					</div>
					<div class="text-end">
